...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    It allows us to get access to match data without rendering the route it comes from.

2. How would you explain form validation to someone who has never programmed before?

    Form validation is used to make sure that the necessary information is entered into an online form before being able to submit.

3. In 1-2 sentences, define end to end testing.

    End to end testing is making sure that forms can be filled out, checking for bugs that can break the app and checking if that data is sent properly.
